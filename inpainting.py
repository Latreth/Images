...
while bool:
    ...
    dOmega, normale = etape1a.IdentifyTheFillFront(masque, source)


    confiance, data, index = etape1b2a.calculPriority(im, taillecadre, masque, dOmega, normale, data, gradientX, gradientY, confiance)


    list, pp = etape2b.calculPatch(dOmega, index, im, original, masque, taillecadre)


    im, gradientX, gradientY, confiance, source, masque = etape3.update(im, gradientX, gradientY, confiance, source, masque, dOmega, pp, list, index, taillecadre)
